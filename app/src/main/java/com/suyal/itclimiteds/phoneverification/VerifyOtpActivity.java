...
import com.suyal.itclimiteds.databinding.ActivityVerifyOtpBinding;
...
public class VerifyOtpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       binding.continueBtn01.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {

               if(binding.otpView.getText().toString().isEmpty()){

                   Toast.makeText(VerifyOtpActivity.this, "Blank field cannot be processed", Toast.LENGTH_SHORT).show();
...
//                                Toast.makeText(VerifyOtpActivity.this, "Dear, You logged in Successfully", Toast.LENGTH_SHORT).show();
                            }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(VerifyOtpActivity.this, "Sign in code error", Toast.LENGTH_SHORT).show();
