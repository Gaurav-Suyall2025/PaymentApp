...
import com.suyal.itclimiteds.adapters.DrawerAdapter;
...
public class MainActivity extends AppCompatActivity implements DrawerAdapter.OnItemSelectedListener{
    ...
    private static final int POS_NEARBY_KYC = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setSelected(POS_NEARBY_KYC);
    }
    ...
    public void onItemSelected(int position) {
        ...
        else if (position == POS_NEARBY_KYC){
            KycNearMe nearbyResFragment = new KycNearMe();
